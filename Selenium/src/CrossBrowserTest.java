...
public class CrossBrowserTest {
	...
	public static void main(String[] args) {
		...
		String authkey = "thabcdef";
		
		CrossBrowserTest cbt = new CrossBrowserTest(username,authkey);
		
		DesiredCapabilities caps = new DesiredCapabilities();
		caps.setCapability("name", "CrossBrowserTest");
	...
	public CrossBrowserTest(String username, String authkey) {
